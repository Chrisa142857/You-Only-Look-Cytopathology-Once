...
class RNN(nn.Module):
    ...
    def forward(self, input_seq, hidden):
        ...
        return self.sigmoid(predictions)[..., 0], hidden, out
...
class LSTM(nn.Module):
    ...
    def forward(self, input_seq, hidden):
        ...
        if valid_shape != hidden[1].shape[1]:
            predictions = predictions[:valid_shape]
        return self.sigmoid(predictions)[..., 0], hidden, lstm_out
...
class GRU(nn.Module):
    ...
    def forward(self, input_seq, hidden):
        ...
        if valid_shape != self.batch_size:
            predictions = predictions[:valid_shape]
        return self.sigmoid(predictions)[:, -1, 0], hidden, lstm_out
...
class Transformer(nn.Module):
    ...
    def forward(self, x, mask = None):
        ...
        return self.sigmoid(pred)[..., 0], out
